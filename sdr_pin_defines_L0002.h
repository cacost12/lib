...
/* Rev 4.0 */
	...
	extern UART_HandleTypeDef         huart4; /* Wireless UART      */
...
/* Rev 5.0 */
	...
	#define PRESSURE_MUXC_PIN         GPIO_PIN_11
	#define PRESSURE_MUX_ALL_PINS     ( (uint16_t) 0x0E00 )
	#define PRESSURE_PT5_PIN          GPIO_PIN_2
	#define PRESSURE_PT6_PIN          GPIO_PIN_3
	#define PRESSURE_PT7_PIN          GPIO_PIN_4
	#define PRESSURE_PT8_PIN          GPIO_PIN_5
	...
	/* Pressure transducers */
	#define PRESSURE_GPIO_PORT        GPIOD
	#define PRESSURE_GPIO_PORT2       GPIOC
